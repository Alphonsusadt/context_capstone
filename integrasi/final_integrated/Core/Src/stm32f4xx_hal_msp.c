...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOE, Echo_1_Pin|Echo_2_Pin|Echo_3_Pin);

    HAL_GPIO_DeInit(Echo_4_GPIO_Port, Echo_4_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC9     ------> TIM8_CH4
    */
    HAL_GPIO_DeInit(GPIOC, Echo_8_Pin|Echo_7_Pin|Echo_6_Pin|Echo_5_Pin);
